...
Here’s the starting prompt. This will be used during the lab, you don't need to do anything with it adhead of time. It’s a bit vague on purpose so we can tweak whatever results we get.
