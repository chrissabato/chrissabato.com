...
Summary: A running collection of things I use and things I often recommend
Tags: featured
---

## A collection of things I use or recommend
Folks often ask me about things I use or recommend. As that happens I will add them to this page as a quick reference

### Media Day & Photography
* Media Day Logo Backdrop
...
### Broadcast
* Specialty Kits
    * Camera Rails Kit — [Photo Gallery](https://photos.app.goo.gl/2SkN4m4ZxBeoadpT6) — [Amazon List](https://a.co/d9yRfHA)
    * Tennis Streaming — [Photo Gallery](https://photos.app.goo.gl/rqjET9TaSSWfiN7HA) — [Amazon List](https://a.co/f07gqZ6)
* Audio
    ...
    * Behringer HA400 | Headphone amplifier — [Amazon](https://a.co/d/2pARGKO) — _If you need multiple headsets with a basic mixer._
* Audio Mixers — _A choice of audio mixer really depends on your use case. Personally I like a digital mixer that can be controlled remotely. That won't work if you need something with faders sitting next to the play-by-play_ 
